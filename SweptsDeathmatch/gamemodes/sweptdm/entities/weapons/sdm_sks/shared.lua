...
SWEP.WorldModel   = "models/weapons/pistol.mdl"
...
SWEP.WElements = {
	["sks"] = { type = "Model", model = "models/weapons/world/rifles/sks.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.518, 0.629, -2.81), angle = Angle(180, 0, 0), size = Vector(1.149, 1.149, 1.149), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
