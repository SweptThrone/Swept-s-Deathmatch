...
SWEP.WorldModel   = "models/weapons/tfa_w_fn_fal.mdl"
...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/world/rifles/rk95.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.079, 0.458, -2.533), angle = Angle(-5.009, 0.377, 180), size = Vector(0.987, 0.987, 0.987), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
