...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/w_sr25.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.987, 1.348, -0.273), angle = Angle(7.774, -180, 180), size = Vector(1.046, 1.046, 1.046), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
