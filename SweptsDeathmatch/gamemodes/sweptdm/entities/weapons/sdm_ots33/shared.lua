...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/world/pistols/ots33.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.625, 1.7, -3.221), angle = Angle(-6.996, 0, 180), size = Vector(1.046, 1.046, 1.046), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
