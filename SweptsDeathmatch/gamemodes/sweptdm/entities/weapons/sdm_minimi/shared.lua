...
SWEP.CompM4Pos = Vector(-2.665, -4, 0.97)
SWEP.CompM4Ang = Vector(0, 0, 0)

SWEP.CompM4Pos_Bipod = Vector(-1.75, -4, 0.18)
SWEP.CompM4Ang_Bipod = Vector(-0.084, 0, 0)

SWEP.ELCANPos = Vector(-2.665, 2.55, 0.47)
SWEP.ELCANAng = Vector(-0.5, 0, 0)
	
SWEP.ELCANPos_Bipod = Vector(-1.74, 4.15, -0.45)
SWEP.ELCANAng_Bipod = Vector(-0.17, 0, 0)

SWEP.EoTechPos_Bipod = Vector(-1.74, -2, -0.488)
SWEP.EoTechAng_Bipod = Vector(1.17, 0, 0)
	
SWEP.EoTechPos = Vector(-2.665, -2, 0.47)
...
SWEP.Sounds["deploy_first01"] = {[1] = {time = .15, sound = Sound("FAS2_UZI.StockUnfold")}}
