...
SWEP.AimPos = Vector(-2.28, 0, 0.36)
SWEP.AimAng = Vector(-0.101, 0, 1.799)
	
SWEP.CompM4Pos = Vector(-2.3, -0.9, -0.64)
...
SWEP.Attachments = {[1] = {header = "Sight", sight = true, x = 800, y = 100, atts = {"compm4"}},
...
SWEP.Anims.Fire_Last = {"fire", "fire2", "fire3"}
SWEP.Anims.Fire_Aiming = {"fire", "fire2", "fire3"}
SWEP.Anims.Fire_Aiming_Last = {"fire", "fire2", "fire3"}
