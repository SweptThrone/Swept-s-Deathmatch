...
SWEP.WorldModel   = "models/weapons/tfa_w_amd_65.mdl"
...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/world/rifles/ak12.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-11.754, 5.311, -8.332), angle = Angle(0, 0, 180), size = Vector(1.129, 1.129, 1.129), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}