...
SWEP.WorldModel   = "models/weapons/tfa_w_snip_m14sp.mdl"
...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/w_m14.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.718, 1, 1.417), angle = Angle(5.29, 180, 180), size = Vector(1.184, 1.184, 1.184), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
