...
SWEP.WElements = {
	["mp5k"] = { type = "Model", model = "models/weapons/w_mp5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.736, 0.175, -0.082), angle = Angle(171.802, 0, 0), size = Vector(1.003, 1.003, 1.003), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
