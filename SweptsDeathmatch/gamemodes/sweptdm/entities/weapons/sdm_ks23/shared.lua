...
SWEP.WElements = {
	["gun"] = { type = "Model", model = "models/weapons/world/shotguns/ks23.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(5.493, 1.088, -3.415), angle = Angle(-13.056, 0, 180), size = Vector(1.156, 1.156, 1.156), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
